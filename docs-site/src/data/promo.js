...
同时，平台界面风格**与品牌调性完全统一**：默认**科技蓝**主题、顶栏与底栏亮色分层、冷白金属质感，支持**四套主题色**（科技蓝 / 品牌黄 / 生态绿 / 中国红）与**夜间模式**一键切换，白天办公、夜间值守都舒适。`,
  },
  {
    id: 'scenario',
    title: '控排企业的一天',
    body: `## 五、走进真实场景：控排企业的一天
...
> 无论钢铁、水泥、化工还是有色，这套"感知 → 建模 → 仿真 → 寻优 → 执行 → 汇报"的闭环方法一以贯之——换个行业，只是换一套工序模型。`,
  },
  {
    id: 'future',
    title: '持续进化的智能能力',
...
### 6. 云端消息流与智能对话
平台提供**云端消息流追踪**，设备上报、服务状态、部署回执全链路可视化，断链自动重连；**LLM 智能体**支持自然语言问答、策略解析与 AI 报告生成，数字专家随问随答，报告一键生成。`,
  },
  {
    id: 'vision',
    title: '设计愿景',
    body: `## 七、设计愿景：低耗能 · 低碳 · 保护地球
