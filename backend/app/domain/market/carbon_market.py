...
from app.core.netutil import TtlCache, fetch_json, fetch_text, now_iso
from app.domain.market import create_forecast_method, create_quote_source
...
# backend/data/market_snapshot.json（统一走配置中心 DATA_DIR：本模块 2026-09-21 从
# backend/app/ 下沉到 app/domain/market/ 后，旧的 parent.parent/"data" 会漂移到
# backend/app/domain/data/，快照静默写到错位目录，重启回退失效）
_SNAPSHOT_PATH = Path(DATA_DIR) / "market_snapshot.json"
