...
OutputDir=..\..
; 产物名须与 build-desktop.yml 的 files 及官网下载链接保持一致（SteelCarbonTwin-windows-x64-setup.exe）
...
SetupIconFile=..\..\platform\windows-deploy\icon.ico
WizardStyle=modern
