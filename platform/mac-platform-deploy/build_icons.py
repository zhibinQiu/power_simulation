"""从项目根 icon.png 生成 macOS 打包所需的 .icns 图标。

依赖：Pillow（pip install Pillow）
用法：
    python platform/mac-platform-deploy/build_icons.py

设计稿源：项目根 icon.png（任意尺寸方形 PNG，最佳 1024×1024）
输出：platform/mac-platform-deploy/icon.icns
"""
import argparse
import sys
...
SRC = ROOT / "icon.png"
ICNS_OUT = ROOT / "platform" / "mac-platform-deploy" / "icon.icns"
